...
public class RefrigeratorGUI extends RefrigeratorDisplay implements ActionListener{
    ...
    public void setFridgeTempDisplay() {
        gui.fridgeTempStatus.setText("Fridge temp <" + refrigerator.getFridgeTemp() + ">");
    }
    ...
    public void setFreezerTempDisplay() {
        gui.freezerTempStatus.setText("Freezer temp <" + refrigerator.getFreezerTemp() + ">");
    }
    ...
    public void setRoomTempDisplay() {
        gui.roomTempStatus.setText("Room temp <" + refrigerator.getRoomTemp() + ">");
    }
}
